          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final statuses = ['Pending', 'Preparing', 'Ready', 'Delivered', 'Completed'];
                final statusColors = [
                  Colors.orange,
                  Colors.blue,
                  Colors.purple,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: statusColors[index % statusColors.length].withOpacity(0.1),
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            _buildOrderItem('Chicken Burger', '2x', 'RM 10.00'),
                            const Divider(height: 20),
                            _buildOrderItem('Fried Rice', '1x', 'RM 8.00'),
                            const Divider(height: 20),
                            _buildOrderItem('Orange Juice', '2x', 'RM 6.00'),
                          ],
                        ),
                      ),
                      const SizedBox(height: 16),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          if (index < 3) // Show track button for active orders
                            ElevatedButton(
                              onPressed: () {
